  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: " border border-primary rounded-lg py-3 px-6",
        ...
        head_row: "flex ",
        head_cell:
          "text-muted-foreground  rounded-md w-9 text-gray-4b4b4b p-[10px] font-bold text-[14px]",
        ...
        day: cn(
          ...
          " p-[10px] text-sm font-semibold aria-selected:opacity-100 "
        ),
